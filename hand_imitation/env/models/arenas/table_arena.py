...
class TableArena(Arena):
    ...
    def add_shapenet_object(self, object_name, pos, quat, free=True, density=1000, idn=0, scale=1, **kwargs):
        shapenet_object = SHAPENETObject(object_name, free, density, idn, scale=scale, **kwargs)
