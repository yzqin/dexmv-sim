# Source: https://github.com/ARISE-Initiative/robosuite/blob/master/robosuite/models/arenas/arena.py
import numpy as np
from hand_imitation.env.models.base import MujocoXML
from hand_imitation.env.utils.mjcf_utils import (ENVIRONMENT_COLLISION_COLOR, array_to_string,
                                                 find_elements, new_element,
